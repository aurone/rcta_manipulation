...
private:
    ...
    typedef actionlib::SimpleActionServer<rcta::ObjectDetectionAction> ObjectDetectionActionServer;
    ...
    rcta::ObjectDetectionFeedback feedback_;
    rcta::ObjectDetectionResult result_;
    ...
    void object_detection_callback(const rcta::ObjectDetectionGoal::ConstPtr& goal);
...
void PickAndPlaceNode::object_detection_callback(const rcta::ObjectDetectionGoal::ConstPtr& goal)
{

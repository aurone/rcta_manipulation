...
ManipulatorInterfaceROS::RunResult ManipulatorInterfaceLiveROS::run()
{
    ...
    while (ros::ok()) {
            ...
            manip_.getMotorCurrent(raw_joint_currents) != ManipulatorError::NO_ERROR())
        {
            ...
            rcta::JointState hdt_joint_state;
...
bool ManipulatorInterfaceLiveROS::init()
{
    ...
    hdt_joint_states_pub_ = nh_.advertise<rcta::JointState>("hdt_joint_states", 1);
...
void ManipulatorInterfaceLiveROS::emergency_stop_callback(const rcta::EmergencyStop::ConstPtr& msg)
{
    estopped_ = true;
    halt();
}

void ManipulatorInterfaceLiveROS::clear_emergency_stop_callback(const rcta::ClearEmergencyStop::ConstPtr& msg)
{
    estopped_ = false;
}
...
void ManipulatorInterfaceLiveROS::acknowledge_reset_callback(const rcta::AcknowledgeReset::ConstPtr& msg)
{

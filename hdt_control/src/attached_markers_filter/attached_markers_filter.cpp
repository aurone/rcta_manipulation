        ...
        for (const auto& marker : msg->markers) {
            if (tracking_marker(marker.id)) {
                ...
                std::vector<Eigen::Affine3d> marker_transform_candidates = {
                        ...
                        camera_to_actual_marker * Eigen::AngleAxisd(smpl::angles::to_radians( 90.0), Eigen::Vector3d(0.0, 0.0, 1.0)),
                        camera_to_actual_marker * Eigen::AngleAxisd(smpl::angles::to_radians(180.0), Eigen::Vector3d(0.0, 0.0, 1.0)),
                        camera_to_actual_marker * Eigen::AngleAxisd(smpl::angles::to_radians(270.0), Eigen::Vector3d(0.0, 0.0, 1.0))
                };
